...
class ColorProvider with ChangeNotifier {
  ...
  //Color authCardColor = Colors.white;
  //Color authBackgroundColor = const Color.fromRGBO(236, 240, 241, 1);
  ...
  void switchToDarkThemeMode() {
    ...
    // authCardColor = const Color.fromRGBO(44, 62, 80, 1).withOpacity(1);
    shadowColor = Colors.black;
    // authBackgroundColor = const Color.fromRGBO(23, 32, 42, 1);
  ...
  void switchToLightThemeMode() {
    ...
    genralBackgroundColor = const Color.fromRGBO(208, 211, 212, 1);
    //  authCardColor = Colors.white;
    // authBackgroundColor = const Color.fromRGBO(208, 211, 212, 1);
