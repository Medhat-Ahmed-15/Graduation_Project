...
class _CompleteProfileScreenState extends State<CompleteProfileScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      phoneNumberBorderColor = colorProviderObj.genralBackgroundColor;
      phoneNumberFillColor = colorProviderObj.genralBackgroundColor;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Container(
                margin: const EdgeInsets.only(top: 50, left: 25, right: 30),
              ...
              Container(
                margin: const EdgeInsets.only(top: 35, left: 25, right: 30),
                decoration: BoxDecoration(
                  color: addressFillColor,
                  border: Border.all(
                    color: addressBorderColor,
