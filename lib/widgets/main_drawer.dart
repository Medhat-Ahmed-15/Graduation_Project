        ...
        child: Column(
          children: [
            ...
            buildListTile('assets/images/help.png', 'Get help', context, () {
              Navigator.of(context)
                  .pushReplacementNamed(GetHelpScreen.routeName);
            }),
